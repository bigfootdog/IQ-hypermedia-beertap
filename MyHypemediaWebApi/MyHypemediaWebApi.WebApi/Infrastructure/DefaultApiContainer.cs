...
using MyHypemediaWebApi.ApiServices;
using MyHypemediaWebApi.ApiServices.Security;
using MyHypemediaWebApi.Documentation.Installers;
using MyHypemediaWebApi.WebApi.Handlers;
using MyHypemediaWebApi.WebApi.Hypermedia;
using MyHypemediaWebApi.WebApi.Infrastructure.Installers;
using MyHypemediaWebApi.Model;
using IQ.Platform.Framework.WebApi.Infrastructure;

namespace MyHypemediaWebApi.WebApi.Infrastructure
{
    ...
    public class DefaultApiContainer : ApiContainer
    {
        ...
        {
            return
                _windsorContainer.Resolve<ApiSecurityContextProvidingHandler<MyHypemediaWebApiApiUser, NullUserContext>>();
        }
